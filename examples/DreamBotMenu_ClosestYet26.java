...
//        JLabel t = new JLabel(" DreamBotMan", SwingConstants.LEFT); t.setForeground(ACCENT_BLOOD); t.setFont(new Font("Segoe UI", Font.BOLD, 32)); t.setBorder(new EmptyBorder(0, 25, 0, 0));
